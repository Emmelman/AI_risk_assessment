...
1. Твой probability_reasoning должен содержать МИНИМУМ 1000 слов.
2. Твой impact_reasoning должен содержать МИНИМУМ 1000 слов.  
3. ОБЯЗАТЕЛЬНО рассмотри ВСЕ 5 пунктов в каждом разделе.
4. Используй конкретные цифры, суммы, сроки, проценты.
5. Ссылайся на детальное саммари агента в каждом пункте.
6. Приводи реальные примеры из российской банковской практики.
7. ВСЕ РЕКОМЕНДАЦИИ ДОЛЖНЫ БЫТЬ СФОРМУЛИРОВАНЫ ПО МЕТОДОЛОГИИ SMART.
